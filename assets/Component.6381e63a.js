import{d as r,P as s,_ as d,r as n,o as c,e as $,a as o,w as u,f as i,n as p,b as l}from"./index.d767eba6.js";import{_ as f}from"./CodeBlock.vue_vue_type_script_setup_true_lang.b59501de.js";const g=r({name:"DocsStylesVariables",components:{PageHeader:s,CodeBlock:f}}),m=l("p",{class:"docs--p"}," If you use sass styles in your app you can overwrite default variables with your own variables. For this you have to define your own variable values before importing the library configuration. For example: ",-1),b=l("p",{class:"docs--p"},"Full list of default colors:",-1),h=l("p",{class:"docs--p"},"Breakpoints:",-1),y=l("p",{class:"docs--p"},"Typography:",-1),x=l("p",{class:"docs--p"},"Other variables:",-1);function w(a,k,_,F,v,E){const t=n("PageHeader"),e=n("CodeBlock");return c(),$("div",{class:p(a.$bem({}))},[o(t,null,{default:u(()=>[i(" Variables ")]),_:1}),m,o(e,{language:"js",code:`
// vue.config.js
...
$hover-transition: all $animation-time-long ease-in-out !default;
      `})],2)}const z=d(g,[["render",w]]);export{z as default};
