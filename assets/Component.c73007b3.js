import{_ as s,d as t,P as d,r,o as c,e as i,a as o,w as $,n as f,f as u,b as n}from"./index.8ac12abf.js";import{_ as p}from"./CodeBlock.33a871aa.js";const m=t({name:"DocsStylesVariables",components:{PageHeader:d,CodeBlock:p}}),g=u(" Variables "),h=n("p",{class:"docs--p"}," If you use sass styles in your app you can overwrite default variables with your own variables. For this you have to define your own variable values before importing the library configuration. For example: ",-1),y=n("p",{class:"docs--p"}," And in your scss config file: ",-1),b=n("p",{class:"docs--p"}," Full list of default colors: ",-1),x=n("p",{class:"docs--p"}," Breakpoints: ",-1),k=n("p",{class:"docs--p"}," Typography: ",-1),w=n("p",{class:"docs--p"}," Other variables: ",-1);function _(a,v,z,C,j,O){const l=r("PageHeader"),e=r("CodeBlock");return c(),i("div",{class:f(a.$bem({}))},[o(l,null,{default:$(()=>[g]),_:1}),h,o(e,{language:"js",code:`
// vue.config.js
