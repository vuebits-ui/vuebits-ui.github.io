import{_ as r,P as c,$ as p}from"./index.e5dbef19.js";import{d as l,b as t,o as d,c as m,k as e,w as u,n as g,l as o,i as n}from"./vendor.5a863b1c.js";const f=l({name:"DocsGettingStartedConfiguration",components:{PageHeader:c,CodeBlock:p}}),$=o(" Configuration "),_=n("p",{class:"docs--p"}," If you want to customize your library you can pass config along with ui. For example: ",-1),y=n("p",{class:"docs--p"}," You can also overwrite scss variables used in library. For this purpose import scss styles in your app instead of css: ",-1),b=n("p",{class:"docs--p"},[o(" And configure your "),n("code",null,"vue.config.json"),o(" file in the following way: ")],-1),h=n("p",{class:"docs--p"},[o(" and import library config in "),n("code",null,"/src/assets/styles/config.scss"),o(" file: ")],-1),w=n("p",{class:"docs--p"}," Now you can set your own scss variables that will overwrite variables used in library, for example: ",-1);function v(a,x,C,z,B,F){const i=t("PageHeader"),s=t("CodeBlock");return d(),m("div",{class:g(a.$bem({}))},[e(i,null,{default:u(()=>[$]),_:1}),_,e(s,{language:"js",code:`
import Vue from 'vue';
